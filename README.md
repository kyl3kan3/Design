...
| 06 | [Cursor & Spotlight](concepts/06-cursor-spotlight.html) | Cursor-led | Custom cursor with lag, mass, and context states; a mask-image flashlight reveal |
...
| 08 | [Aurora Ambient Hero](concepts/08-aurora-hero.html) | Living backgrounds | Drifting blurred gradient field, stepped film grain, `@property` conic-ring CTA, headline shimmer |
...
| 10 | [Attention Cues](concepts/10-attention-cues.html) | Notification design | The salience ladder: unread dots, pulses, bell wiggle, spring toasts with pause-on-hover, one confetti |
...
| 12 | [Text Decode](concepts/12-text-decode.html) | Type in motion | Headlines resolving from cipher noise, hover scrambles, in-view decodes |
